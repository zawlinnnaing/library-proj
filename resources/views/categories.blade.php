        ...
        <i class="fa fa-angle-down" aria-hidden="true"></i>
            ...
            <div class="column content">
                <div class="descrip message is-dark">
                    ...
                    @if($title == 'Reference')
                        <div class="message-body">
                            Reference Book means :a book containing useful facts or specially organized information, as
                            an encyclopedia, dictionary, atlas, yearbook, etc.
                        </div>
                    @elseif ($title == 'Thesis')
                        <div class="message-body">
                ...
                <div class="content">
                    ...
                    @foreach($books as $book) @php $book->title = ucwords($book->title); $book->author = ucwords($book->author); @endphp
                    <div class="books">
